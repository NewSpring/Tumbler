...
def _getArgs():
    ...
    parser.add_argument(
        "--zero", help="Runs the Zero Dollar Transaction Report", action="store_true"
    )
    parser.add_argument(
        "--sync",
        help="Syncs Rock pre-alpha. In safe mode, will do an Alpha PR and stop. In fast mode, will merge and deploy beta automatically.",
        action="store_true",
    )
    parser.add_argument(
